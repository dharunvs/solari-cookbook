    ...
    <main className="min-h-screen bg-canvas-soft text-ink" id="main-content">
      <header className="border-b border-hairline bg-canvas">
        <div className="mx-auto flex min-h-16 max-w-5xl flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6">
          <Link className="text-sm font-medium" href={`/projects/${projectId}`}>
            NOXYN{" "}
            <span className="font-normal text-body">/ {project.name}</span>
          </Link>
          <span className="font-mono text-xs text-body">SOLARI / SANDBOX</span>
        </div>
      </header>
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 font-mono text-xs text-body">
                        ...
                        {run.configuration_version} · attempt {run.attempt}
                      </p>
                    </div>
